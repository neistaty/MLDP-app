...
pri_memory_amount_gb = st.number_input('Primary Memory Amount (GB)', min_value=32, max_value=2000, value=256, step=32)
sec_memory_amount_gb = st.number_input('Secondary Memory Amount (GB)', min_value=0, max_value=2000, value=0, step=128)
cpu_ghz = st.number_input('CPU GHz', min_value=1.0, max_value=5.0, value=2.5, step=0.1)
