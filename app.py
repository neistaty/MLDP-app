...
pri_memory_amount_gb = st.number_input('Primary Memory Amount (GB)', min_value=8, max_value=2000, value=256, step=8)
sec_memory_amount_gb = st.number_input('Secondary Memory Amount (GB)', min_value=0, max_value=2000, value=0, step=8)
